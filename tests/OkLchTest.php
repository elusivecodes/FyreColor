...
final class OkLchTest extends TestCase
{
    ...
    public function testGetChroma(): void
    {
        ...
        $this->assertEquals(0.027017845397763564, $color->getChroma());
    }
    ...
    public function testGetHue(): void
    {
        ...
        $this->assertEquals(285.80269594678555, $color->getHue());
    }
    ...
    public function testGetLightness(): void
    {
        ...
        $this->assertEquals(0.9309007554171675, $color->getLightness());
    }
