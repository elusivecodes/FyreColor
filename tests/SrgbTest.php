...
final class SrgbTest extends TestCase
{
    ...
    {
        $color1 = Srgb::createFromString('lavender');
        $color2 = Srgb::createFromString('black');
    ...
    public function testGetBlue(): void
    {
        ...
        $this->assertEquals(0.9803921568627451, $color->getBlue());
    }
    ...
    public function testGetGreen(): void
    {
        ...
        $this->assertEquals(0.9019607843137255, $color->getGreen());
    }
    ...
    public function testGetRed(): void
    {
        ...
        $this->assertEquals(0.9019607843137255, $color->getRed());
    }

    public function testLabel(): void
    {
        $color = Srgb::createFromString('lavender')->withGreen(0.5);
    ...
    public function testSpace(): void
    {
        ...
        $this->assertSame('srgb', $color->space());
    }
    ...
    {
        $color = Srgb::createFromString('lavender')->withAlpha(0.5);

        $this->assertSame(
            'color(srgb 0.9 0.9 0.98 / 0.5)',
            $color->toString()
        );
    }
