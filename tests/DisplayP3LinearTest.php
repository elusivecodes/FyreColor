...
final class DisplayP3LinearTest extends TestCase
{
    ...
    public function testGetBlue(): void
    {
        ...
        $this->assertEquals(0.9410301564589402, $color->getBlue());
    }
    ...
    public function testGetGreen(): void
    {
        ...
        $this->assertEquals(0.7912845848400826, $color->getGreen());
    }
    ...
    public function testGetRed(): void
    {
        ...
        $this->assertEquals(0.7913982143903506, $color->getRed());
    }
