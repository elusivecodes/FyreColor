...
final class DisplayP3Test extends TestCase
{
    ...
    public function testGetBlue(): void
    {
        ...
        $this->assertEquals(0.9736175624246136, $color->getBlue());
    }
    ...
    public function testGetGreen(): void
    {
        ...
        $this->assertEquals(0.901954054471058, $color->getGreen());
    }
    ...
    public function testGetRed(): void
    {
        ...
        $this->assertEquals(0.9020113103701475, $color->getRed());
    }
    ...
    public function testLuma(): void
    {
        ...
        $this->assertSame(0.8031875740317757, $color->luma());
    }
